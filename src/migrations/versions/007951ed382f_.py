...
Revision ID: 007951ed382f
Revises:
Create Date: 2025-03-17 05:42:24.507648
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("current_game_state", sa.String(length=26), nullable=False),
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
